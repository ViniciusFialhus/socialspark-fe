...
export default function ModalNewName() {
  ...
  const [input, setInput] = useState(!userInfo.letterName ? userInfo.clientId : letterName);
  ...
  return (
    <div className={styles.containerMain}>
      <main className={styles.Modal}>
        ...
        <h5 className={styles.detailInform}>Your current name is {userInfo.clientId}</h5>
      </main>
    </div>
  );
}
